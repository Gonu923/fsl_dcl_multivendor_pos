...
@section('content-header', 'Create Employee')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="employee_uid"
                                    class="form-control @error('employee_uid') is-invalid @enderror" id="employee_uid"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="employee_designation"
                                    class="form-control @error('employee_designation') is-invalid @enderror" id="employee_designation"
                                    placeholder="Employee Designation" value="{{ old('employee_designation') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="employee_salary"
                                    class="form-control @error('employee_salary') is-invalid @enderror" id="employee_salary"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="employee_working_area"
                                    class="form-control @error('employee_working_area') is-invalid @enderror"
                                    id="employee_working_area" placeholder="employee_working_area"
                                    value="{{ old('employee_working_area') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="employee_live_location"
                                    class="form-control @error('employee_live_location') is-invalid @enderror"
                                    id="employee_live_location" placeholder="employee_live_location"
                                    value="{{ old('employee_live_location') }}">
